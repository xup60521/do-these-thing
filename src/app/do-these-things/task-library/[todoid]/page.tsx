    ...
    <div className="flex w-[70rem] max-w-full flex-col px-16">
      <h1 className="flex w-full flex-col gap-2 py-12 pt-16 text-left font-mono text-2xl font-bold">
        ...
        <div className="flex min-w-0 items-center gap-3">
          <span className="max-w-full flex-shrink text-wrap break-words">
            {todo.todoTitle}
          </span>
        ...
        {todo.rules && (
          <Link
            href={`/do-these-things/rule/${todo.rules.ruleId}`}
            className="w-fit cursor-pointer rounded-full bg-neutral-500 p-1 px-2 font-mono text-xs text-white"
          >{`generated by: ${todo.rules.ruleTitle}`}</Link>
        )}
      </h1>
